...
# Save the high agreement DataFrame to JSON format
high_agreement_json = high_agreement_df.to_dict(orient="records")

output_path = "/projects/illinois/eng/cs/jimeng/zelalae2/scratch/med_students/high_agreement_annotations.json"
with open(output_path, "w") as f:
    json.dump(high_agreement_json, f, indent=2)
